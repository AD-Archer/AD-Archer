              ...
              <div className="flex flex-col space-y-6">
                <div className="flex flex-col space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="mailto:adarcher21@gmail.com" className="text-foreground hover:text-primary transition-colors">
                      adarcher21@gmail.com
                    </a>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+12672256778" className="text-foreground hover:text-primary transition-colors">
                      +1 (267) 225-6778
                    </a>
                  </div>
                ...
                <div className="pt-4">
                  <p className="text-sm text-muted-foreground mb-4">Response time: Usually within 48 hours</p>
