              ...
              <CardContent>
                {activeSkill ? (
                  ...
                  <p className="text-muted-foreground">
                    Hover over a skill in the visualization to see more details about my proficiency and experience.
                  </p>
                )}
              </CardContent>
            </Card>
...
function getSkillDescription(skillName: string): string {
  const descriptions: Record<string, string> = {
    ...
    TypeScript: "Strong TypeScript skills with experience in type definitions, generics, and advanced type patterns.",
    "Tailwind CSS":
      "Proficient in Tailwind CSS for rapid UI development with custom configurations and component systems.",
    "Node.js": "Experienced in building backend services with Node.js, including REST APIs and microservices.",
    Express: "Skilled in Express.js for creating robust server applications with middleware and routing.",
    MongoDB:
      "Experienced with MongoDB for document databases, including aggregation pipelines and indexing strategies.",
    PostgreSQL: "Proficient in PostgreSQL for relational data, including complex queries and performance optimization.",
    GraphQL: "Skilled in GraphQL API development with Apollo Server and Client.",
    Firebase: "Experience with Firebase services including Authentication, Firestore, and Cloud Functions.",
    AWS: "Knowledge of AWS services including S3, Lambda, EC2, and CloudFront.",
    Docker: "Proficient in containerization with Docker and Docker Compose for development and deployment.",
  ...
  return descriptions[skillName] || `Skilled in ${skillName} with professional experience in various projects.`
}
