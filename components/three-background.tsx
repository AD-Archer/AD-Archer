  ...
  useEffect(() => {
    ...
    const initThree = async () => {
      try {
        ...
        const textSprites = codeTexts.map(item =>
          createTextSprite(item.text, item.position, item.color)
        );
        ...
        const animate = () => {
          ...
          particles.forEach(particle => {
            ...
            // Pulse movement
            const pulse =
              Math.sin(time * particle.pulseSpeed + particle.timeOffset) * particle.pulseAmount;
